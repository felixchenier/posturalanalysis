...
class MplCanvas(FigureCanvasQTAgg):
    """Canvas for the Matplotlib figure."""
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        """Generate the interface and connect to its callback functions."""
    ...
    def SaveButton(self):
        ...
        if dataPath == "" or groupPath == "":
            ...
            if self.newsave.isChecked():
                DataController.SaveToNewDocument(self.data, dataPath)
            else:
            ...
            DataController.SaveToExistingGroupDocument(
                self.data,
                groupDataPath=groupPath,
                rowToWrite=self.rowSB.value(),
                participant=subject,
            )
